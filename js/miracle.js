...
function randomEvent(){
    let set = [
        ...
        "You're practicing your courtly manners for the king's visit. Call everyone Milord and Milady for the rest of class. Everyone gains 2 SP.",
        "Gift of the game master! The teacher gives a surprise to all players! Everyone gains 3 SP.",
        ...
        "An angel decides to help the feeble. The player with the least XP receives 300XP. Everyone gains 2 SP.",
        "You find a potion and give it to your weakest teammate. The player with the fewest SP receives 2 SP. Everyone gains 1 SP.",
        "We see it once in a year, twice in a week, and never in a day. What is it? ...The letter 'E'! The teacher picks 6 letters. Each team must come up with as many words as possible using only those letters in 30 seconds.The team with the most words gains 250XP. Everyone gains 2 SP.",
        "Amazon Prime would like you to review an item you purchased. One random player stands in front of the board, facing away from it. All other students come and write one truthful compliment about that student on the board behind him or her. The teacher will take a picture of the board before you sit down. Everyone gains 3 SP.",
        ...
        "An alien lands and bestows strange new powers. Each team can choose one team member to gain 300 XP. Everyone gains 2 SP.",
        ...
        "You drink from a fountain of wisdom and are surged with power. It feels dangerous... Everyone gains 2 SP, but the surge of power makes you lose 1HP if you use a skill today- unless you're a healer. They're especially resistant to surges.",
        "Today's your lucky day! One random player receives 50 GP! Everyone gains 3 SP.",
        ...
        "If you are good subjects, the king will reward you. If no one loses any HP today, the Gamemaster must distribute candy at the next class. Everyone gains 2 SP.",
        "Someone mispronounced Hocus Pocus and the spell backfired! All players receive 200 XP if they stand and do the Hokey Pokey. Everyone gains 2 SP.",
        "You go to train under the master healer who imparts his wisdom to you. All healers gain 200 XP. Everyone gains 1 SP.",
        "It's raining cats and dogs! All players must end their sentences with 'meow' or 'woof.' Everyone gains 3 SP.",
        ...
        "The teacher picks an action (EG: sitting down). For the remainder of class, every time the teacher does that action, the first student to stand up gets 50 XP. Everyone gains 2 SP.",
        "The Gamemaster is feeling generous today! Everyone receives 20 XP and 20 GP! Everyone gains 2 SP.",
        "You find a small leather bag hidden beneath a rock. Inside is a small potion in a clear bottle. The liquid inside swirls with colors. You see red, blue, gold, and green spiral inside. One random player rolls a D6 to see what happens! 1: Lose 1 SP. 2: Lose 3 HP. 3: Gain 1 SP. 4: Gain 3 HP. 5: Gain 100 XP. 6: Gain 20 GP. Everyone gains 3 SP.",
